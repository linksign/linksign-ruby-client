...
module SwaggerClient
  ...
  class DocumentDefinition
    ...
    # \u5176\u5B83\u63A5\u6536\u4EBA
    attr_accessor :extra_recipients
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'extraRecipients']
        self.extra_recipients = attributes[:'extraRecipients']
      end
      
      if attributes[:'idAuth']
        self.id_auth = attributes[:'idAuth']
      end
      
      if attributes[:'signers']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          ...
          extra_recipients == o.extra_recipients &&
          id_auth == o.id_auth &&
          signers == o.signers &&
    ...
    def hash
      [app, custom_fields, documents, extra_recipients, id_auth, signers, template_id].hash
    end
