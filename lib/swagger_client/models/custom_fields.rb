...
module SwaggerClient
  ...
  class CustomFields
    ...
    attr_accessor :image_custom_fields
    ...
    def self.swagger_types
      {
        :'image_custom_fields' => :'Array<ImageCustomField>',
    ...
    def initialize(attributes = {})
      ...
      if attributes[:'imageCustomFields']
        if (value = attributes[:'imageCustomFields']).is_a?(Array)
          self.image_custom_fields = value
        end
      end
      
      if attributes[:'textCustomFields']
    ...
    def ==(o)
      ...
      self.class == o.class &&
          image_custom_fields == o.image_custom_fields &&
    ...
    def hash
      [image_custom_fields, text_custom_fields].hash
    end
